...
const PLUGINS: PluginDefinition[] = [
  {
    id: "prestadores",
    name: "Portal de Prestadores y Guardias",
    category: "Recursos Humanos y Asistencia",
    description: "Tarifas de guardias ordinarias y críticas, horas de extensión asistencial y tope normativo de facturación.",
    icon: Stethoscope,
  ...
  return (
    <div className="space-y-6">
      ...
      {!selectedPluginId ? (
        ...
        /* VISTA 2: FORMULARIO DE PARÁMETROS DEL PLUGIN SELECCIONADO */
        <div className="space-y-6">
