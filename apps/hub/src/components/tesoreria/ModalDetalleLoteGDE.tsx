    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto p-0 border-slate-200 dark:border-slate-800">
        ...
        <div className="bg-slate-900 text-white p-5">
          <div className="flex items-start justify-between gap-3">
            <div>
              ...
              <DialogTitle className="text-lg font-bold text-white tracking-tight mt-1.5 font-mono">
                Expediente: {lote.numero_expediente_gde || "Sin carátula"}
              </DialogTitle>
            ...
            <div className="text-right">
              <div className="text-xs text-slate-400">Total Neto a Liquidar</div>
        ...
        <div className="p-5 space-y-4">
          ...
          <div className="flex flex-wrap items-center justify-between gap-2 p-3 bg-slate-50 dark:bg-slate-900/50 rounded-lg border border-slate-200 dark:border-slate-800">
            <div className="flex flex-wrap items-center gap-2">
              ...
              <Button
                ...
                className="text-xs border-emerald-300 text-emerald-800 dark:border-emerald-800 dark:text-emerald-300 hover:bg-emerald-50 dark:hover:bg-emerald-950/40 flex items-center gap-1.5"
              >
          ...
          <div className="p-3.5 rounded-lg border border-purple-200 dark:border-purple-900/50 bg-purple-50/40 dark:bg-purple-950/20 space-y-2.5">
            <div className="text-xs font-bold text-purple-950 dark:text-purple-300 flex items-center gap-1.5">
              ...
              Retorno de Despacho: Acto Administrativo / Resolución de Pago
            </div>
            {lote.numero_resolucion ? (
              ...
              <div className="flex flex-col sm:flex-row gap-2 pt-1">
                ...
                <Button
                  ...
                  className="h-8 text-xs bg-purple-700 hover:bg-purple-800 text-white font-medium"
                >
          ...
          {lote.estado !== "pagado_bse" && (
            <div className="p-3.5 rounded-lg border border-emerald-200 dark:border-emerald-900/50 bg-emerald-50/40 dark:bg-emerald-950/20 space-y-2.5">
              <div className="text-xs font-bold text-emerald-950 dark:text-emerald-300 flex items-center gap-1.5">
                <CheckCircle2 className="h-4 w-4 text-emerald-700" />
                Cierre de Pago en Banca Empresa BSE
              </div>
              <div className="flex flex-col sm:flex-row gap-2 pt-1">
                <Input
