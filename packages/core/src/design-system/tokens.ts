// Design System Tokens - Hub Hospitalario
// Sistema de tokens para consistencia visual en aplicaciones médicas
...
export const colors = {
  ...
  // Colores de información - Azul claro
  info: {
    50: '#eff6ff',
    100: '#dbeafe',
    200: '#bfdbfe',
